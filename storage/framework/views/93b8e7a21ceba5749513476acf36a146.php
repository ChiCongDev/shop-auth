<?php $__env->startSection('title', 'Giỏ hàng của tôi'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-4" id="danh-sach-gio-hang">
                ...
                <?php
                    ...
                    $anh = $anhArr[0] ?? null;
                ?>
                <div class="item-gio-hang bg-white rounded-2xl p-4 flex gap-4 shadow-sm border border-gray-100" data-id="<?php echo e($item->id); ?>">
                    
                    <a href="/san-pham/<?php echo e($item->sanPham?->ma_chung); ?>" class="shrink-0">
                        <div class="w-20 h-20 rounded-xl overflow-hidden bg-gray-50">
                            <?php if($anh): ?>
                                <img src="<?php echo e(asset('storage/uploads/sanpham/' . $anh)); ?>" alt="<?php echo e($item->sanPham?->ten); ?>"
                    ...
                    <div class="flex-1 min-w-0">
                        <a href="/san-pham/<?php echo e($item->sanPham?->ma_chung); ?>" class="font-semibold text-gray-900 hover:text-yellow-600 line-clamp-2 text-sm">
                            <?php echo e($item->sanPham?->ten ?? 'Sản phẩm'); ?>

                        </a>
                        <div class="text-sm font-bold mt-1" style="color:#1a1a2e">
                            <?php echo e(number_format($item->gia, 0, ',', '.')); ?>đ
                        </div>

                        <div class="flex items-center justify-between mt-3">
                            
                            <div class="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                                <button onclick="capNhatSoLuong(<?php echo e($item->id); ?>, -1)"
                                    class="px-3 py-1.5 text-gray-500 hover:bg-gray-50 transition-colors text-sm font-bold">−</button>
                                <span id="sl-<?php echo e($item->id); ?>" class="px-3 py-1.5 text-sm font-semibold text-gray-900 min-w-[2.5rem] text-center"><?php echo e($item->so_luong); ?></span>
                                <button onclick="capNhatSoLuong(<?php echo e($item->id); ?>, 1)"
                                    class="px-3 py-1.5 text-gray-500 hover:bg-gray-50 transition-colors text-sm font-bold">+</button>
                            </div>
                            ...
                            <div class="flex items-center gap-3">
                                <span id="tt-<?php echo e($item->id); ?>" class="font-bold text-sm" style="color:#1a1a2e">
                                    <?php echo e(number_format($item->so_luong * $item->gia, 0, ',', '.')); ?>đ
                                </span>
                                <button onclick="xoaKhoiGio(<?php echo e($item->id); ?>)"
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-24">
                    ...
                    <div class="space-y-3 mb-5">
                        <div class="flex justify-between text-sm text-gray-600">
                            <span>Tạm tính</span>
                            <span id="tong-tam-tinh" class="font-medium"><?php echo e(number_format($tongTien, 0, ',', '.')); ?>đ</span>
                        </div>
                        <div class="flex justify-between text-sm text-gray-600">
                        ...
                        <div class="flex justify-between font-bold text-gray-900">
                            <span>Tổng cộng</span>
                            <span id="tong-cuoi" class="text-lg" style="color:#1a1a2e"><?php echo e(number_format($tongTien, 0, ',', '.')); ?>đ</span>
                        </div>
                    </div>
...
<?php echo app('Illuminate\Foundation\Vite')('resources/js/gioHang/index.js'); ?>
<script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\workspace\projects-company\shop-auth 21-4\shop-auth\resources\views/gioHang/index.blade.php ENDPATH**/ ?>