...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Shop Auth'); ?> — Thời Trang Chính Hãng</title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Shop Auth - Quần áo, giày dép hàng chính hãng chất lượng cao'); ?>">
...
<body class="bg-gray-50 font-['Inter']">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a href="/gio-hang"
                       class="relative touch-min w-11 justify-center text-gray-600 hover:text-gray-900 transition-colors">
                        ...
                        <?php if(isset($tongSoLuongGioHang) && $tongSoLuongGioHang > 0): ?>
                        <span class="absolute top-1 right-0.5 bg-red-500 text-white rounded-full w-4 h-4
                            ...
                            <?php echo e($tongSoLuongGioHang > 9 ? '9+' : $tongSoLuongGioHang); ?>
                    ...
                    <div class="relative" id="wrap-tai-khoan">
                        <button id="btn-tai-khoan"
                            ...
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold shrink-0"
                                ...
                                <?php echo e(mb_substr(session('tenDangNhap', 'K'), 0, 1)); ?>

                            </div>
                            <span class="hidden md:block text-sm font-medium"><?php echo e(session('tenDangNhap')); ?></span>
                        </button>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-3" id="thong-bao-toast">
        <div class="flex items-start gap-3 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-xl">
            ...
            <span class="text-sm font-medium flex-1"><?php echo e(session('thongBao')); ?></span>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-3" id="loi-toast">
        <div class="flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-xl">
            ...
            <span class="text-sm font-medium flex-1"><?php echo e(session('loi')); ?></span>
    ...
    <footer class="hidden md:block mt-20 text-white py-12" style="background: #1a1a2e">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-700 mt-8 pt-6 text-center text-gray-500 text-xs">
                © <?php echo e(date('Y')); ?> Shop Auth. Tất cả quyền được bảo lưu.
            </div>
        </div>
    </footer>
        ...
        <div class="grid grid-cols-4">
            ...
            <a href="/"
               class="flex flex-col items-center justify-center py-1.5 gap-0.5
                      <?php echo e(Request::is('/') ? 'text-yellow-500' : 'text-gray-500 hover:text-gray-700'); ?>">
                <svg class="w-6 h-6" fill="<?php echo e(Request::is('/') ? 'currentColor' : 'none'); ?>"
            ...
            <a href="/san-pham"
               class="flex flex-col items-center justify-center py-1.5 gap-0.5
                      <?php echo e(Request::is('san-pham*') ? 'text-yellow-500' : 'text-gray-500 hover:text-gray-700'); ?>">
                <svg class="w-6 h-6" fill="<?php echo e(Request::is('san-pham*') ? 'currentColor' : 'none'); ?>"
                     stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="/gio-hang"
               class="flex flex-col items-center justify-center py-1.5 gap-0.5 relative
                      <?php echo e(Request::is('gio-hang') ? 'text-yellow-500' : 'text-gray-500 hover:text-gray-700'); ?>">
                <div class="relative">
                    <svg class="w-6 h-6" fill="<?php echo e(Request::is('gio-hang') ? 'currentColor' : 'none'); ?>"
                         stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
            ...
            <a href="/don-hang"
               class="flex flex-col items-center justify-center py-1.5 gap-0.5
                      <?php echo e(Request::is('don-hang*') ? 'text-yellow-500' : 'text-gray-500 hover:text-gray-700'); ?>">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                </svg>
...
<?php /**PATH D:\workspace\projects-company\shop-auth 21-4\shop-auth\resources\views/layouts/app.blade.php ENDPATH**/ ?>