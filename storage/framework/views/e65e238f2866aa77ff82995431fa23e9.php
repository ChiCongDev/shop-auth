<?php $__env->startSection('title', 'Khách trả hàng order'); ?>
...
<div id="danh-sach-phieu-tra-order" data-doi-tac-quyen="<?php echo e(session('doi_tac_quyen')); ?>" class="mx-auto max-w-7xl px-4 pb-8 pt-6 sm:px-6 sm:pt-8 lg:px-8">
    ...
    <div class="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-4">
        <?php $__currentLoopData = [
            ...
            <button type="button" data-return-status-card="<?php echo e($item['ma']); ?>" class="rounded-lg border border-gray-200 bg-white p-4 text-left shadow-sm transition hover:border-yellow-300 hover:shadow-md">
                <div class="text-sm font-semibold text-gray-500"><?php echo e($item['ten']); ?></div>
                <div id="stat-return-<?php echo e($item['ma']); ?>" class="mt-3 text-2xl font-bold text-gray-900">0</div>
                <span class="mt-2 inline-flex rounded-full px-2.5 py-1 text-xs font-semibold <?php echo e($item['lop']); ?>">Order</span>
            </button>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/doiTac/orderHang/danhSachPhieuTraHangOrder.js'); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\workspace\projects-company\shop-auth 21-4\shop-auth\resources\views/doiTac/orderHang/danhSachPhieuTraHangOrder.blade.php ENDPATH**/ ?>