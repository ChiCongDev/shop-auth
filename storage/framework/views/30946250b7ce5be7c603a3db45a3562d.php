<?php $__env->startSection('title', 'Đổi/trả hàng order ' . $don_hang->ma_don_hang); ?>
    ...
    <div class="mx-auto max-w-7xl space-y-5">
        <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div>
                    <a href="/doi-tac/order-hang/don-ban/<?php echo e($don_hang->id); ?>" class="text-sm font-semibold text-gray-500 hover:text-gray-900">Quay lại chi tiết đơn</a>
                    <h1 class="mt-3 text-2xl font-bold text-gray-950">Đổi/trả hàng order</h1>
                    <p class="mt-2 text-sm text-gray-500">
                        Đơn bán <span class="font-semibold text-gray-900"><?php echo e($don_hang->ma_don_hang); ?></span>
                        từ đơn order <span class="font-semibold text-gray-900"><?php echo e($don_order->ma_don_order); ?></span>
                    </p>
                </div>
        ...
        <section class="grid gap-4 lg:grid-cols-3">
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <p class="mt-2 font-bold text-gray-950"><?php echo e($don_hang->khachHang?->ten ?? $don_order->khachHang?->ten ?? '-'); ?></p>
                <p class="mt-1 text-sm text-gray-500"><?php echo e($don_hang->khachHang?->sdt ?? $don_order->khachHang?->sdt ?? '-'); ?></p>
            </div>
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <p class="mt-2 text-lg font-bold <?php echo e($lopTrangThai); ?>"><?php echo e($tenTrangThai); ?></p>
            </div>
        </section>
                ...
                <table class="w-full min-w-[1080px] text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        <?php $__currentLoopData = $don_hang->chiTietDonHangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chiTiet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr
                                data-return-row
                                data-san-pham-id="<?php echo e($chiTiet->san_pham_id); ?>"
                                data-chi-tiet-don-hang-id="<?php echo e($chiTiet->id); ?>"
                                data-ten-san-pham="<?php echo e($chiTiet->sanPham?->ten ?? 'Sản phẩm'); ?>"
                                data-ma-sku="<?php echo e($chiTiet->sanPham?->ma_sku ?? ''); ?>"
                                data-don-vi-tinh="<?php echo e($chiTiet->sanPham?->don_vi_tinh ?? 'Chiếc'); ?>"
                                data-so-luong-ban="<?php echo e((int) $chiTiet->so_luong); ?>"
                                data-gia-ban="<?php echo e((float) $chiTiet->gia_ban); ?>"
                            >
                                <td class="px-4 py-4 text-center text-gray-500"><?php echo e($loop->iteration); ?></td>
                                <td class="px-4 py-4">
                                ...
                                <td class="px-4 py-4 text-center font-semibold text-gray-800"><?php echo e(number_format($chiTiet->so_luong, 0, ',', '.')); ?></td>
                                <td class="px-4 py-4 text-center font-semibold text-gray-500" data-da-tra>0</td>
                                <td class="px-4 py-4 text-center font-semibold text-gray-950" data-con-tra><?php echo e(number_format($chiTiet->so_luong, 0, ',', '.')); ?></td>
                                <td class="px-4 py-4">
                                ...
                                <td class="px-4 py-4">
                                    <input type="text" value="<?php echo e(number_format($chiTiet->gia_ban, 0, ',', '.')); ?>" data-gia-tra class="w-full rounded-lg border border-gray-200 px-3 py-2 text-right text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-yellow-400">
                                </td>
                                <td class="px-4 py-4">
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/doiTac/orderHang/doiTraHangOrder.js'); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\workspace\projects-company\shop-auth 21-4\shop-auth\resources\views/doiTac/orderHang/doiTraHangOrder.blade.php ENDPATH**/ ?>