                ...
                <div class="bg-white rounded-2xl p-8">
                    ...
                    <form method="POST" action="/dang-ky" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="tel" name="sdt" value="<?php echo e(old('sdt')); ?>" required
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 transition-all"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\workspace\projects-company\shop-auth 21-4\shop-auth\resources\views/auth/dangKy.blade.php ENDPATH**/ ?>