<?php $__env->startSection('title', 'Chi tiết hàng được phép order'); ?>

<?php $__env->startSection('content'); ?>
<?php echo $__env->make('doiTac.orderHang._nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<div id="chi-tiet-sp-duoc-phep-order" data-ma-chung="<?php echo e($maChung); ?>" class="mx-auto max-w-7xl px-4 pb-10 pt-6 sm:px-6 sm:pt-8 lg:px-8">
...
<div id="modal-tao-order-nhanh" class="fixed inset-0 z-[80] hidden bg-black/40 p-4">
    <div class="mx-auto mt-8 max-h-[88vh] max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div class="max-h-[calc(88vh-76px)] overflow-y-auto p-5">
            ...
            <?php if(in_array(session('doi_tac_quyen'), ['admin', 'thu_kho', 'quan_ly_order'])): ?>
...
<script>
    window.coTheChonNhanVienOrder = <?php echo e(in_array(session('doi_tac_quyen'), ['admin', 'thu_kho', 'quan_ly_order'], true) ? 'true' : 'false'); ?>;
</script>
<?php echo app('Illuminate\Foundation\Vite')('resources/js/doiTac/orderHang/chiTietSanPhamDuocPhepOrder.js'); ?>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\workspace\projects-company\shop-auth 21-4\shop-auth\resources\views/doiTac/orderHang/chiTietSanPhamDuocPhepOrder.blade.php ENDPATH**/ ?>