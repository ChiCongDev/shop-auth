@extends('layouts.app')
@section('title', 'Chi tiết đơn order')

@section('content')
@include('doiTac.orderHang._nav')
<div id="chi-tiet-order-doi-tac" data-order-id="{{ $orderId }}" data-role="{{ session('doi_tac_quyen') }}" class="mx-auto max-w-7xl px-4 pb-8 pt-6 sm:px-6 sm:pt-8 lg:px-8">
...
@push('scripts')
@vite('resources/js/doiTac/orderHang/chiTietDonOrder.js')
@endpush
@endsection
