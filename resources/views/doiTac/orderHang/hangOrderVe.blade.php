...
<div id="hang-order-ve-doi-tac" class="mx-auto max-w-7xl px-4 pb-8 pt-6 sm:px-6 sm:pt-8 lg:px-8">
    ...
    <div class="mb-6 grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-6">
        ...
        <button type="button" data-order-status-card="{{ $item['ma'] }}" class="order-status-card rounded-lg border border-gray-200 bg-white p-4 text-left transition-all duration-200 hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md">
            <div class="mb-3 flex items-center justify-between gap-3">
                <div class="text-sm text-gray-500">{{ $item['ten'] }}</div>
            ...
            <div id="stat-order-{{ $item['ma'] }}" class="text-2xl font-bold text-gray-900">0</div>
...
@push('scripts')
@vite('resources/js/doiTac/orderHang/hangOrderVe.js')
@endpush
@endsection
